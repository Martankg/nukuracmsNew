...
class Configuration{
	...
	private function loadSystemConfigurations(){
		if (file_exists(HOST.'/system/configurations/sys_configs.conf')) $this->conf = System::parse('/system/configurations/sys_configs.conf');
	}
	...
	public static function configCreatMini($STG){
		...
		if (!$STG['DB_HOST']) $STG['DB_HOST'] = Configuration::set()->get('DB_HOST');
		if (!$STG['DB_NAME']) $STG['DB_NAME'] = Configuration::set()->get('DB_NAME');
		if (!$STG['DB_USER']) $STG['DB_USER'] = Configuration::set()->get('DB_USER');
		if (!$STG['DB_PASS']) $STG['DB_PASS'] = Configuration::set()->get('DB_PASS');
