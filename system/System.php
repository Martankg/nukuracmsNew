...
class System{
	...
	public static function printTemplate(){
		...
		else if(!file_exists(HOST.'/ornotuu/index.php')) include(HOST.'/templates/'.TEMPLATE.'/temp_index.php');
		else include(HOST.'/ornotuu/error.php');
	}
	//Билдирүү жөнөтүү
	...
	protected static function loadSystemLanguages(){
		global $_LANG;
